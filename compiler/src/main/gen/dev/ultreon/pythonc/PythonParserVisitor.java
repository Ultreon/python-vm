 ...
 *
 * @param <T> The return owner of the visit operation. Use {@link Void} for
 * operations with no return owner.
 */
public interface PythonParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link PythonParser#fstring_input}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFstring_input(PythonParser.Fstring_inputContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link PythonParser#soft_kw_type}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSoft_kw_type(PythonParser.Soft_kw_typeContext ctx);
	/**
	 * Visit a parse tree produced by {@link PythonParser#soft_kw_match}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSoft_kw_match(PythonParser.Soft_kw_matchContext ctx);
	/**
	 * Visit a parse tree produced by {@link PythonParser#soft_kw_case}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSoft_kw_case(PythonParser.Soft_kw_caseContext ctx);
	/**
	 * Visit a parse tree produced by {@link PythonParser#soft_kw_wildcard}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSoft_kw_wildcard(PythonParser.Soft_kw_wildcardContext ctx);
	/**
	 * Visit a parse tree produced by {@link PythonParser#soft_kw__not__wildcard}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSoft_kw__not__wildcard(PythonParser.Soft_kw__not__wildcardContext ctx);
}