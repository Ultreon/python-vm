...
public class PyIsNode implements PyComparisionNode {
    private PyExprNode left;
    private final PyExprNode right;

    public PyIsNode(PyExprNode left, PyExprNode right) {
        this.left = left;
        this.right = right;
    }
    ...
    public void compile(MethodNode method, PyCompileContext context) {
        ...
        method.visitMethodInsn(Opcodes.INVOKESTATIC, "python/_core/Py", "is", "(Ljava/lang/Object;Ljava/lang/Object;)Z", false);
    }
