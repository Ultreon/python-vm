...
public class PyInNode implements PyComparisionNode {
    private PyExprNode left;
    private final PyExprNode right;

    public PyInNode(PyExprNode left, PyExprNode right) {
        this.left = left;
        this.right = right;
    }
    ...
    public void compile(MethodNode method, PyCompileContext context) {
        ...
        method.visitMethodInsn(Opcodes.INVOKESTATIC, "python/_core/Py", "contains", "(Ljava/lang/Object;Ljava/lang/Object;)Z", false);
    }
